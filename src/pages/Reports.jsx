...
const st = {
  ...
  exportBtn: {
    background: 'var(--accent)', color: 'var(--accent-contrast)', border: 'none', padding: '12px 20px',
    fontSize: 14, fontWeight: 600, borderRadius: 'var(--radius-sm)', cursor: 'pointer',
  },
  filters: {
    display: 'flex', gap: 12, alignItems: 'flex-end', flexWrap: 'wrap',
    background: 'var(--bg-card, #161616)', border: '1px solid var(--border, #222)',
    padding: 16, borderRadius: 'var(--radius-lg)', marginBottom: 20,
  },
  filterGroup: { display: 'flex', flexDirection: 'column', gap: 6, minWidth: 180 },
  label: { fontSize: 12, color: 'var(--text-secondary, #888)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' },
  input: {
    background: 'var(--bg-input, #0a0a0a)', color: 'var(--text, #fff)', border: '1px solid var(--border, #333)', borderRadius: 'var(--radius-sm)',
    padding: '10px 12px', fontSize: 14, fontFamily: 'inherit',
  },
  rangeLabel: { fontSize: 13, color: 'var(--text-secondary, #888)', padding: '10px 0', fontFamily: 'var(--font-mono)' },
  loading: { color: 'var(--text-secondary, #888)', textAlign: 'center', padding: 24 },
  errorBox: {
    background: 'var(--error-soft)', border: '1px solid var(--error)',
    color: 'var(--error)', padding: 14, borderRadius: 'var(--radius-md)', marginBottom: 16, fontSize: 13, lineHeight: 1.5,
  },
  warnBox: {
    background: 'var(--warning-soft)', border: '1px solid var(--warning)',
    color: 'var(--warning)', padding: 12, borderRadius: 'var(--radius-md)', marginBottom: 16, fontSize: 13,
  },
  payHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16, marginBottom: 14, flexWrap: 'wrap' },
  paySub: { fontSize: 13, color: 'var(--text-secondary, #888)', margin: '4px 0 0 0' },
  ...
  kpiLabel: { fontSize: 12, color: 'var(--text-secondary, #888)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' },
  ...
  cardHint: { fontSize: 12, color: 'var(--text-secondary, #94a3b8)', fontFamily: 'var(--font-mono)' },
  twoCol: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(420px, 1fr))', gap: 20 },
  empty: { color: 'var(--text-tertiary, #666)', textAlign: 'center', padding: 24, fontSize: 13 },
  table: { width: '100%', borderCollapse: 'collapse', fontSize: 13 },
  th: { textAlign: 'left', padding: '8px 12px', borderBottom: '1px solid var(--border, #222)', color: 'var(--text-secondary, #888)', fontWeight: 600, fontSize: 12, textTransform: 'uppercase' },
  td: { padding: '10px 12px', borderBottom: '1px solid var(--border, #181818)' },
  footnote: { fontSize: 12, color: 'var(--text-tertiary, #666)', marginTop: 16, lineHeight: 1.6 },
};
