...
const s = {
  container: { minHeight: '100vh', backgroundColor: '#111', color: '#fff', padding: '24px 16px', fontFamily: 'system-ui,sans-serif', maxWidth: 1000, margin: '0 auto' },
  ...
  backBtn: { background: 'none', border: 'none', color: '#666', fontSize: 14, cursor: 'pointer', padding: 0, marginBottom: 12, minHeight: 32 },
  jobRow: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    backgroundColor: '#1a1a1a', border: '1px solid #333', borderRadius: 12,
  ...
  miniStat: { textAlign: 'center', flex: 1, color: '#fff', fontSize: 18 },
  miniLbl: { fontSize: 12, color: '#888' },
  exportBtn: {
    padding: '14px 28px', borderRadius: 8, border: '1px solid #3B82F6',
    backgroundColor: '#1e3a5f', color: '#fff', fontSize: 16, fontWeight: 600, cursor: 'pointer',
    marginTop: 8,
  },
};
