...
const k = {
  container: { minHeight: '100vh', backgroundColor: '#0a0a0a', color: '#fff', fontFamily: 'system-ui,sans-serif', padding: '20px 24px' },
  topBar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  jobName: { fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 800, margin: 0 },
  modeLabel: { color: '#666', fontSize: 14 },
  clock: { fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 300, color: '#888', fontFamily: 'monospace' },
  bigRow: { display: 'flex', gap: 24, justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' },
  bigStat: { textAlign: 'center', minWidth: 140 },
  bigVal: { fontSize: 'clamp(36px, 6vw, 56px)', fontWeight: 900, lineHeight: 1, color: '#fff' },
  bigLbl: { fontSize: 13, color: '#888', letterSpacing: 2, fontWeight: 600, marginTop: 4 },
  progressContainer: { height: 16, backgroundColor: '#222', borderRadius: 8, overflow: 'hidden', position: 'relative', marginBottom: 24 },
  ...
  mainRow: { display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 20, marginBottom: 20 },
  section: { backgroundColor: '#111', borderRadius: 12, padding: 16, border: '1px solid #222' },
  sectionTitle: { fontSize: 16, fontWeight: 700, color: '#aaa', margin: '0 0 12px', letterSpacing: 1 },
  podGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 10 },
  podCard: { backgroundColor: '#1a1a1a', borderRadius: 8, padding: 12, border: '2px solid #333' },
  ...
  podPace: { fontSize: 13, color: '#888' },
  leaderboard: { maxHeight: 300, overflowY: 'auto' },
  leaderRow: { display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0', borderBottom: '1px solid #222' },
  rank: { fontSize: 18, width: 36, textAlign: 'center', fontWeight: 700 },
  leaderName: { flex: 1, fontSize: 15, fontWeight: 600, color: '#ddd' },
  leaderCount: { fontSize: 16, fontWeight: 800, color: '#fff', fontFamily: 'monospace' },
};
