...
const st = {
  ...
  exportBtn: { padding: '8px 16px', borderRadius: 8, border: '1px solid #444', backgroundColor: '#222', color: '#fff', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  setupLink: { padding: '8px 16px', borderRadius: 8, backgroundColor: '#333', color: '#aaa', fontSize: 13, fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center' },
  ...
  progressContainer: { height: 8, backgroundColor: '#333', borderRadius: 4, overflow: 'hidden', marginBottom: 24 },
  ...
  panelBtn: { padding: '8px 16px', borderRadius: 8, border: '1px solid #444', backgroundColor: 'transparent', color: '#aaa', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  panel: { backgroundColor: '#1a1a1a', borderRadius: 12, border: '1px solid #333', maxHeight: 420, overflowY: 'auto', marginBottom: 16 },
  exRow: { display: 'flex', gap: 12, alignItems: 'center', padding: '10px 16px', borderBottom: '1px solid #222', flexWrap: 'wrap' },
