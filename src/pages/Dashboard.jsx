...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard-screen" style={st.container}>
      ...
      {/* Daily Crew & Pay panel \u2014 owner-only role-based payroll */}
        ...
        <div style={st.panel}>
          <div style={{ padding: 16 }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center', marginBottom: 16 }}>
              ...
              <p style={{ color: '#888', fontSize: 12, margin: 0, alignSelf: 'flex-end' }}>
                Enter # on shift, hours, and rate per role. Saves to <code style={{ color: '#888' }}>dailyPay/{job?.id || '\u2026'}_{crewDateKey}</code>.
              </p>
            </div>
