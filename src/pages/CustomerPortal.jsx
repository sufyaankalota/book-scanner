...
export default function CustomerPortal() {
  ...
  const deletePO = async (uploadId, isAdded = false) => {
    ...
    try {
      // Delete manifest chunks (if chunked) — best-effort; continue even if some chunks are missing
...
const st = {
  loginContainer: {
    minHeight: '100vh', backgroundColor: 'var(--bg, #0a0a0a)', display: 'flex',
  ...
  loginInput: {
    ...
    backgroundColor: 'var(--bg-input, #1a1a1a)', color: 'var(--text, #f0f0f0)', fontSize: 16, boxSizing: 'border-box',
    textAlign: 'center', letterSpacing: 2, fontWeight: 500,
  },
  loginBtn: {
  ...
  topBar: {
    ...
    marginBottom: 24, paddingBottom: 16, borderBottom: '1px solid var(--border, #1e1e1e)',
  },
  logoutBtn: {
    padding: '6px 14px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border, #2a2a2a)',
  ...
  rateChip: {
    ...
    backgroundColor: 'var(--signal-soft)', color: 'var(--signal)', letterSpacing: 0.3,
  },
  tabBar: { display: 'flex', gap: 4, marginBottom: 20, flexWrap: 'wrap' },
  tab: {
    padding: '8px 14px', borderRadius: 'var(--radius-sm)', borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--border, #1e1e1e)',
    backgroundColor: 'var(--bg-subtle, #0f0f0f)', color: 'var(--text-tertiary, #666)', fontSize: 12, fontWeight: 600, cursor: 'pointer',
  },
  ...
  input: {
    width: '100%', padding: '11px 14px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border, #2a2a2a)',
    backgroundColor: 'var(--bg-input, #1a1a1a)', color: 'var(--text, #f0f0f0)', fontSize: 14, boxSizing: 'border-box', fontWeight: 500,
  },
  smallBtn: {
    padding: '6px 12px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border, #2a2a2a)',
    backgroundColor: 'var(--bg-elev, #161616)', color: 'var(--text-secondary, #888)', fontSize: 11, fontWeight: 600,
  ...
  th: { padding: '8px 12px', textAlign: 'left', borderBottom: '1px solid var(--border, #1e1e1e)', color: 'var(--text-tertiary, #666)', fontWeight: 600, position: 'sticky', top: 0, backgroundColor: 'var(--bg-subtle, #0f0f0f)', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.3px' },
  td: { padding: '6px 12px', borderBottom: '1px solid var(--border, #1a1a1a)', color: 'var(--text-secondary, #bbb)', fontSize: 13 },
};