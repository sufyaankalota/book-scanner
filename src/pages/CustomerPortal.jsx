...
const st = {
  ...
  loginInput: {
    ...
    backgroundColor: '#1a1a1a', color: '#f0f0f0', fontSize: 16, boxSizing: 'border-box',
  ...
  container: {
    ...
    padding: '16px 20px 40px', fontFamily: "'Inter', 'SF Pro Display', system-ui, -apple-system, sans-serif", maxWidth: 860, margin: '0 auto',
  },
  topBar: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    marginBottom: 24, paddingBottom: 16, borderBottom: '1px solid #1e1e1e',
  },
  logoutBtn: {
  ...
  statBox: {
    backgroundColor: '#141414', borderRadius: 10, padding: '14px 14px', flex: 1,
    minWidth: 90, textAlign: 'center', border: '1px solid #1e1e1e',
  },
  ...
  smallBtn: {
    ...
    backgroundColor: '#161616', color: '#888', fontSize: 11, fontWeight: 600,
